...
<p align="justify" style="padding-bottom:10px">
  ...
  <p align="justify" style="padding-bottom:10px">
  I'm not naturally proficient in drawing, the action of translating our field of vision to a paper requires a special attention to detail that I'm not able to achieve as I would like seamlessly, however, anatomic drawings are for me the most enjoyable of all, because in contrast of displaying proportions as how <i> they look </i> -in landscapes and dead nature- anatomy relies in how proportions <i> should be like </i> because despite of the diviersified physiological traits that humans have, there are some things that remain consistent and that give shape to the visual idea of a <i> human. </i> Nowadays, self-proclaimed artists try to impregnate stylistically their work by deforming the geometry of the bodies and faces they draw, to portait uniqueness, while this is prefectly normal, directionless and intentionless tranfigurations can make an artwork seem as inprecise.
  
  
  <p align="justify" style="padding-bottom:10px">
    Matisse, Picasso, Shiele and many coetaneous artists were <i> a priori </i> excelent in drawing the world in a descriptive manner, is their efficient understanding of the academic principles what gave them the tool to modify their art to successfully generate deformations in a theorical way. This, as good as it is for the mouvements, has provoked a misunderstanding in current days as people approach non-anatomical techniques in drawing and justify it by alluding to a false idea of "abstraction" when their refer to impresion or rather a bad aproach of it. Anatomic study drawing then, is for me, the tool to approach more complex ideas in the future and thus why I value it very much, is by no means "art" -the causal usage of the word "art" and "artist" is something I'll write about probably next week- but is surely the path to art, so that's why enourage its use and the study of it.
    </p>
  </p> 
